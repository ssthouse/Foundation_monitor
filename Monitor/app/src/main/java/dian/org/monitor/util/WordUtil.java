 ...
 * TODO 需要处理一下---要是序号名字改变了怎么办??---文件就--放在那吗??
...
public class WordUtil {
    ...
    public static final String WORD_FILE_PATH = "/data/data/dian.org.monitor/files/";
     ...
     * @param tourItem
     */
    public static void sendWordFile(Context context, TourItem tourItem) {
        Intent intent = new Intent(Intent.ACTION_SEND);
        //获取对应TourItem的文件的URL
        File file = new File(WordUtil.WORD_FILE_PATH + tourItem.getPrjName() +
                "-" + tourItem.getTourNumber()+".doc");
